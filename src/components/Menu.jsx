            ...
            <nav className="cocktail-tabs grid md:grid-cols-4 grid-cols-2 md:gap-20 gap-10 mb-20 relative z-10 md:max-w-6xl md:mx-auto">
                {allLenses.map((lens, index) => {
                    ...
                    return (
                        <button
                            key={lens.id}
                            className={`pb-2 text-xl md:text-3xl border-b transition-colors cursor-pointer font-semibold ${isActive
                                    ? 'text-white border-white'
                                    : 'text-white/50 border-white/50 hover:border-[#0078FF] hover:text-[#0078FF]'
                                }`}
                        ...
                        {currentLens.variants?.map((variant, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-4 py-2 border rounded-lg transition-all text-sm md:text-base font-medium ${isActive
                                            ? 'border-[#0078FF] text-[#0078FF] bg-white/10 shadow-md'
                                            : 'border-white/30 text-white/60 hover:text-[#0078FF] hover:border-[#0078FF]'
                                        }`}
